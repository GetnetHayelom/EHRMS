    ...
    public class CostAnalysisReportModel : PageModel
    {
        ...
        public async Task OnGetAsync(DateTime? start, DateTime? end, int? deptId)
        {
            ...
            TotalLeaveProductivityLoss = await _context.Leaves
                ...
                .Where(l => (l.leaveStartDate >= startDate && l.leaveEndDate <= endDate) && l.leaveTypeModel.leaveJob == false && (l.leaveStatus == Models.leaveStatus.Posted || l.leaveStatus == Models.leaveStatus.Completed))
